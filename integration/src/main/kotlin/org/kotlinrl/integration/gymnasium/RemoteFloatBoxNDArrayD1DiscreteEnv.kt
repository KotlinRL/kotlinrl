...
import org.kotlinrl.core.env.FloatBoxNDArrayD1DiscreteEnv
import org.kotlinrl.open.env.*
import kotlin.random.*

internal class RemoteFloatBoxNDArrayD1DiscreteEnv(
    envName: String,
    seed: Int? = null,
    render: Boolean = true,
    options: Map<String, String> = emptyMap(),
    host: String = "localhost:50051"
) : FloatBoxNDArrayD1DiscreteEnv {
    ...
    override fun step(act: Int): Transition<NDArray<Float, D1>, Float> {
